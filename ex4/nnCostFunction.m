...
for i=1:m
    for k=1:num_labels
        J = J + mapedy(i,k)*log(a3(i,k)) + (1-mapedy(i,k))*log(1-a3(i,k));
        end;
        end;
...
for t=1:m
    ...
    Delta_2 = Delta_2 + delta_3'*[1 a2];
    Delta_1 = Delta_1 + delta_2'*[1 a1];
